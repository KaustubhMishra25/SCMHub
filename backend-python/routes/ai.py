...
from utils.train_queries import get_sample_queries
...
def fetch_response_and_analyse():
  try:
    ...
    try:
      gpt_response = get_response_gpt(query,user_data,sample_queries) # Answer 1
    except Exception as err:
      pass
    print(gpt_response)
    claude_response = get_response_claude(query,user_data,sample_queries) # Answer 2
    print(claude_response)
    gemini_response = get_response_gemini(query,user_data,sample_queries) # Answer 3
